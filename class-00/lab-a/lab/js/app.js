...
let allProducts = [];//const --> let Anthony**
const container = document.getElementById('image_container');
const viewed = [];
const labels = [];
const pics = [leftImage, centerImage, rightImage];
const list = document.getElementById('productlist');
let totalClicks = 0;//const i --> let i ANTHONY
const views = [];
const votes = [];
...
function displayPics() {
  ...
  for (let i = 0; i < 3; i++) {//const i --> let i ANTHONY
    let temp = viewed.shift();//const --> let Anthony**
    // console.log('/././././' + temp);
...
function handleClick(event) {
  ...
  for (let i = 0; i < names.length; i++) {//const i --> let i ANTHONY
...
function showList() {
  for (let i = 0; i < allProducts.length; i++) {//const i --> let i ANTHONY
...
if (localStorage.busmall) {
  ...
  for (let i = 0; i < names.length; i++) {//const --> let Anthony**
    new Product(names[i]);
  }
}
