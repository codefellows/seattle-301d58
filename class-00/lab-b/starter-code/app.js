...
//  The constructor function Student. It populates name: age: and hometown: which are properties within that function. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//  A massive wad of nonesense because 'this' is referring to the global window object, instead of just the constructor object. 
// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions do not bind “this”, so the context of “this” bubbles up to the global window object, which is the next-nearest enclosing scope. Therefore, avoid using an arrow function in a constructor or any method that needs to use “this” to behave properly.
